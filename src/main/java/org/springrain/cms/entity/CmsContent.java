...
public class CmsContent  extends BaseEntity {
    ...
    */
	...
	private java.lang.Integer status; // 0 未审核，1 审核通过，2 审核未通过
	//columns END 数据库字段结束
	...
	@Transient
	@WhereSQL(sql="createDate>=:CmsContent_createStartDate")
	public java.util.Date getCreateStartDate() {
		return createStartDate;
	}

	public void setCreateStartDate(java.util.Date createStartDate) {
		this.createStartDate = createStartDate;
	}
	@Transient
	 @WhereSQL(sql="createDate<=:CmsContent_createEndDate")
	public java.util.Date getCreateEndDate() {
		return createEndDate;
	}

	public void setCreateEndDate(java.util.Date createEndDate) {
