...
public class CmsLink  extends BaseEntity {
    ...
    */
	...
	private String childftlfile;
	//columns END 数据库字段结束
	private Integer updateOld;
	//concstructor
	...
	public CmsLink(String id,String ftlfile,Integer modelType,Integer themeType){
		this.id=id;
	...
	@WhereSQL(sql="themeType=:CmsLink_themeType")
	...
	public String toString() {
		return new StringBuilder()
			...
			.append("siteType[").append(getThemeType()).append("],")
			.toString();
	}
	@WhereSQL(sql="childftlfile=:CmsChannel_childftlfile")
	public String getChildftlfile() {
		return childftlfile;
	}

	public void setChildftlfile(String childftlfile) {
		this.childftlfile = childftlfile;
	}
	public int hashCode() {
	...
	@Transient
	public Integer getUpdateOld() {
		return updateOld;
	}

	public void setUpdateOld(Integer updateOld) {
