...
public interface ICmsChannelService extends IBaseSpringrainService {
	 ...
	 * @throws Exception
	 */
	Integer saveLinkCms(List<CmsLink> cmsLinks,String channelId,String siteId)throws Exception;
	/**
	 * 根据PID找下一级所有的栏目
	 * @param site
	 * @param pid
	 ...
	 * @throws Exception
	 */
	List<CmsChannel> findChanelByPid(String site,String pid)throws Exception;
	
	List<CmsChannel> findChanelByCmsChannel(String site, String pid,CmsChannel cmsChannel,Page page) throws Exception;
}
