...
public interface ICmsCommentService extends IBaseSpringrainService {
	 ...
	 * @throws Exception
	 */
	List<CmsComment> findCommentList(String siteId,CmsComment cmsComment, Page page) throws Exception;
	...
	String saveWechatFile(String serverIds,String siteType,String siteId,String businessId,int transcoding,String suffix,String type) throws WxErrorException, IOException;
