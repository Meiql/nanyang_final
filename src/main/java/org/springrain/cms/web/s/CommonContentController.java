...
@Controller
@RequestMapping(value="/s/content/{siteId}")
public class CommonContentController extends SiteBaseController{
	@Resource
	...
	public String list(HttpServletRequest request, Model model,@PathVariable String siteId,CmsContent cmsContent) throws Exception{
	...
	public String updatepre(Model model,HttpServletRequest request,HttpServletResponse response,@PathVariable String siteId,CmsContent cmsContent) throws Exception{
	...
	@ResponseBody 
	public ReturnDatas saveorupdate(Model model,CmsContent cmsContent,HttpServletRequest request,HttpServletResponse response,@PathVariable String siteId) throws Exception{
	...
	public String look(Model model,HttpServletRequest request,HttpServletResponse response,@PathVariable String siteId)  throws Exception {
		String businessId = request.getParameter("businessId");
	...
	@ResponseBody 
	public ReturnDatas lookjson(Model model,HttpServletRequest request,HttpServletResponse response,@PathVariable String siteId) throws Exception{
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
