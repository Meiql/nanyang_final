...
public class SOrgController extends BaseController {
	...
	@ResponseBody
	public ReturnDatas listjson(HttpServletRequest request, Model model, Org org)
			throws Exception {
		...
		Page page = null;
		// ==执行分页查询
		List<Org> datas = orgService.findListDataByFinder(null, page,
				Org.class, org);
	...
	@ResponseBody
	public ReturnDatas saveorupdate(Model model, Org org,
	...
	public ReturnDatas destroy(HttpServletRequest request) throws Exception {
		...
		try {
			...
			Integer userCountByOrgId = userOrgService
					.findAllUserCountByOrgId(id);
